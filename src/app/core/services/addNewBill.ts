...
const addNewBill = async ({ address, city, province, postalCode, phone, billTo, description, quantity, UnitPrice, amount, userId }: NewBillProps) => {
  const URL = 'http://localhost:3000/api/bill'
